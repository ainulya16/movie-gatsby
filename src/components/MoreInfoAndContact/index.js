...
import { Row as BaseRow, Col } from 'antd';
...
export class MoreInfoAndContact extends React.PureComponent {
  componentDidMount() {
...
MoreInfoAndContact.propTypes = {
  faqData: objectOf(any),
  onGetData: func.isRequired,
};
MoreInfoAndContact.defaultProps = {
  faqData: null,
};
